...
%	      \item Successfully achieved avalanche effect in the encryption function \\[-0.5cm]
%	      \item Carried out stream rank test on the ciphertext generated \\[-0.6cm]
	\end{itemize}
	...
	\begin{itemize}
	      ...
	      %\item Made use of Perf tool, bash scripting, Gnuplot, SVN \\[-0.6cm]
	\end{itemize}
