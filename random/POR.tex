...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{Database Management System} \hfill \emph{(Under Prof. N.L. Sarda, Jul'14-Nov'14)}\\
			Managed the allocation of student to TA for project evaluation\\
			Evaluated assignments and course project of students.
		\item \textbf{Computer Programming and Utilization as JTA}\hfill \emph{(Under Prof. Kavi Arya, Jan'15-Apr'15)}\\
		...
		\item \textbf{Computer Programming and Utilization as STA}\hfill \emph{(Under Prof. Varsha Apte, Jul'15-till-date)}\\
